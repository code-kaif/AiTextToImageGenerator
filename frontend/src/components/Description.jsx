      ...
      <div className="flex flex-col gap-5 md:gap-14 md:flex-row items-center">
        ...
        <div>
          ...
          <p className="text-gray-600 mb-4">
            ...
            Imagify it, describe it, and watch it come to life instanty
          </p>
          <p className="text-gray-600 mb-4">
            Simply type in a text prompt, and out cutting-edge AI will generate
            high-quality images in seconds. From product visulas to character
            designs and portraits, even concept that don't yet exist can be
